const CACHE='terra-italica-v19';
const ASSETS=[
  './','./index.html','./app.css','./game.js','./logistics.js','./persistence.js','./boot.js','./community.js','./population.js','./touch-modifier.js','./p16-render.js','./asset-render.js','./manifest.webmanifest',
