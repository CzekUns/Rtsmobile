const CACHE='terra-italica-v57';
const ASSETS=[
  './','./index.html','./app.css','./game.js','./logistics.js','./market.js','./livestock.js','./persistence.js','./boot.js','./community.js','./population.js','./equipment.js','./character.js','./skills.js','./construction-knowledge.js','./touch-modifier.js','./p16-render.js','./asset-render.js','./manifest.webmanifest',
  ...
  './assets/p16/buildings/building_palisade_p16.png','./assets/p16/buildings/building_mill_p16.png',
  './assets/p16/ui/ui_selection_marker_p16.png'
];
