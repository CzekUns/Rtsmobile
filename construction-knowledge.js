(() => {
  ...
  const RULES={
    ...
    requirements:{road:['insediamento'],warehouse:['insediamento'],house:['insediamento'],farm:['insediamento'],pen:['insediamento'],market:['insediamento'],mill:['molitoria'],bakery:['fornace'],palisade:['fortificazione'],tower:['fortificazione','muratura']}
  };
